...
namespace Сucaracha
{
    public static class CucarachaGenerator
    {
        ...
        public static Cucaracha Generate(System.Windows.Forms.Timer timerUpdate, Graphics graphics, Point position)
        {
            ...
            return new Cucaracha(timerUpdate, graphics, maxVel, minVel, velFrequency, velPhase, position/*, label1*/);
        }
    }
}
